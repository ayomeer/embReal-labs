...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : C Main where hardware get configured by CubeMX HAL.
  * 				  Main program functionality in cppMain.cpp.
  ******************************************************************************
...
int main(void)
{
  ...
  MX_TIM16_Init();
  /* USER CODE BEGIN 2 */
  HAL_TIM_Encoder_Start(&htim4, TIM_CHANNEL_ALL); 	// Start Encoder Timer
